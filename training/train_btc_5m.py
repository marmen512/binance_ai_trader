"""
train_btc_5m.py — тренує RandomForest модель на BTC 5m даних.
"""
...
def train_btc_5m():
    ...
    print(f"Тренування RandomForest...")
    ...
    print("Модель збережено у models/btc_5m_model.pkl")
